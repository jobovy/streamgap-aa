...
\caption{
Angle and frequency distributions for the perturbed and unperturbed stream model: the red histograms show the unperturbed stream $t=0.88\Gyr$ after impact, the green show the perturbed stream and the blue show the unperturbed stream kicked in angle and frequency space and evolved to the current time.
}
\label{model_nzero}
\end{figure*}
